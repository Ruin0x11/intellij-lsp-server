 ...
 */
public class MyProjectTaskRunner extends ProjectTaskRunner {
    private static final Logger LOG = Logger.getInstance(MyProjectTaskRunner.class);
    public static final Key<Object> EXECUTION_SESSION_ID_KEY = ExecutionManagerImpl.EXECUTION_SESSION_ID_KEY;
    private final CompileStatusNotification trueCallback;

    public MyProjectTaskRunner(CompileStatusNotification trueCallback) {
        super();
