...
class RequestDispatchTest {
    ...
    init {
        jsonRpcServer = JsonRpcBasicServer(jacksonObjectMapper(), mockLanguageServerHandler,
                LanguageServerHandler::class.java)
    }
    ...
    fun `responds to initialize`() {
        ...
        verify(mockLanguageServerHandler).doInitialize(1, "file:///", capabilities, "any")
    }
